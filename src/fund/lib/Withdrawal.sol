...
library Withdrawal {
  ...
  function marketTokenAmount(Props memory props) internal pure returns (uint) {
    return props.numbers.marketTokenAmount;
  }

  function setMarketTokenAmount(Props memory props, uint value) internal pure {
    props.numbers.marketTokenAmount = value;
  }

  function minLongTokenAmount(Props memory props) internal pure returns (uint) {
    return props.numbers.minLongTokenAmount;
  }

  function setMinLongTokenAmount(Props memory props, uint value) internal pure {
    props.numbers.minLongTokenAmount = value;
  }

  function minShortTokenAmount(Props memory props) internal pure returns (uint) {
    return props.numbers.minShortTokenAmount;
  }

  function setMinShortTokenAmount(Props memory props, uint value) internal pure {

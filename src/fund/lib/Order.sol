...
library Order {
  ...
  function decreasePositionSwapType(Props memory props)
    internal
    pure
    returns (DecreasePositionSwapType)
  {
    return props.numbers.decreasePositionSwapType;
  }

  function setDecreasePositionSwapType(Props memory props, DecreasePositionSwapType value)
    internal
    pure
  {
  ...
  function sizeDeltaUsd(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setSizeDeltaUsd(Props memory props, uint value) internal pure {
  ...
  function initialCollateralDeltaAmount(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setInitialCollateralDeltaAmount(Props memory props, uint value) internal pure {
  ...
  function triggerPrice(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setTriggerPrice(Props memory props, uint value) internal pure {
  ...
  function acceptablePrice(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setAcceptablePrice(Props memory props, uint value) internal pure {
  ...
  // @param props Props
  // @param value the value to set to
  function setExecutionFee(Props memory props, uint value) internal pure {
  ...
  function executionFee(Props memory props) internal pure returns (uint) {
  ...
  function callbackGasLimit(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setCallbackGasLimit(Props memory props, uint value) internal pure {
  ...
  function minOutputAmount(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setMinOutputAmount(Props memory props, uint value) internal pure {
  ...
  function updatedAtBlock(Props memory props) internal pure returns (uint) {
  ...
  // @param props Props
  // @param value the value to set to
  function setUpdatedAtBlock(Props memory props, uint value) internal pure {
